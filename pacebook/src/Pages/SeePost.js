      ...
      {showPost.map((post) => (
        ...
        >
          <div className="card testimonial-card mt-2 mb-3">
            ...
            <div
              className="card-body text-center" onClick={() =>{navigate(`/click/${post.id}`)}}>
              <h4 className="card-title font-weight-bold">{post.username}</h4>
              <hr />
              <h6>{post.title}</h6>
              <p>
            ...
            <div className="container my-1">
              <button className="btn btn-light" onClick={() =>{likePost(post.id)}}>Like</button>
